...
//	private String LicenseFile     = Environment.getExternalStorageDirectory().getPath()+"/uTTS4NTHUCS/License.dat";
    private String LicenseFile = Environment.getExternalStorageDirectory().getPath()+"/License.dat";
